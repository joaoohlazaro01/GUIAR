...
<head>
  ...
  <link href="<?= BASE_URL ?>/style/loginEmpresa.css" rel="stylesheet" />
  <link
    rel="Shortcut Icon"
    type="image/png"
    ...
    <div class="row align-items-center">
      <center>
        <div class="formulario" id="form">
          ...
          <form method="post" action="<?= BASE_URL ?>/routes.php?action=loginEmpresa">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <a id="esqueceusenha" href="<?= BASE_URL ?>/routes.php?action=esqueceuSenha">Esqueceu sua senha?</a>
            </div>
            <br>
            <input type="submit" class="btn btn-primary" id="botao" value="Entrar"><br>
            <a id="cadastro" href="<?= BASE_URL ?>/routes.php?action=cadastroEmpresa">Não tem uma conta? <spam>Faça cadastro</spam></a>
          </form>
